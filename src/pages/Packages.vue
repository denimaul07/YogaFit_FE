    ...
    <div class="grid grid-cols-12 gap-6 mt-5">
        <div class="col-span-12 2xl:col-span-4">
            <div class="flex flex-wrap items-center col-span-12  intro-y sm:flex-nowrap">
                ...
                <RouterLink :to="{ name: 'packages' }" class="flex items-center pr-4 text-primary mt-5"><Lucide icon="ChevronRight" class="w-4 h-4 mr-3" /> Master Packages</RouterLink>
            </div>
        
        </div>
        <div class="col-span-12 2xl:col-span-4">
            <h2 class="mt-4 text-lg font-medium intro-y items-center text-center">List Data Packages</h2>
        </div>
        <div class="col-span-12 2xl:col-span-4">
                    ...
                    <div class="items-center sm:flex sm:mr-4">
                        <Button variant="primary" class="mr-2 shadow-md" @click="add">
                            <span class="flex items-center justify-center w-40 h-5">
                                <Lucide icon="Plus" class="w-4 h-4" /> Add New Packages
                            </span>
                        </Button>
                            ...
                            <Table>
                                ...
                                <Table.Tbody>
                                    ...
                                    <Table.Tr class="intro-x" v-for="(data, index) in state.listData.data" :key="data.id" >
                                        ...
                                        <Table.Td class="first:rounded-l-md last:rounded-r-md bg-white border-b-0 dark:bg-darkmode-600 shadow-[20px_3px_20px_#0000000b]  text-center">
                                            {{ (1 *data.price).toLocaleString('id-ID', { style: 'currency', currency: 'IDR' }).slice(0, -3) }}
                                        </Table.Td>
                                        <Table.Td class="first:rounded-l-md last:rounded-r-md bg-white border-b-0 dark:bg-darkmode-600 shadow-[20px_3px_20px_#0000000b]  text-center">
                                            {{ data.accesss }}
                                        </Table.Td>
                                        ...
                                        <Table.Td class="first:rounded-l-md last:rounded-r-md w-40 bg-white border-b-0 dark:bg-darkmode-600 shadow-[20px_3px_20px_#0000000b] whitespace-nowrap">
                                            <div
                                                ...
                                                'flex items-center justify-center',
                                                    { 'text-success': data.status_packages==0 },
                                                    { 'text-danger': data.status_packages==1 }
                                                ]"
                                            >
                                                <!-- <Lucide icon="CheckSquare" class="w-4 h-4 mr-2" /> -->
                                                <div v-if="data.status_packages==0">Active</div>
                                                <div v-else-if="data.status_packages==1">Non Active</div>
                    ...
                    <Dialog.Description  class="grid grid-cols-12 gap-4 gap-y-3">
                        <div class="col-span-12 sm:col-span-6 xl:col-span-6 intro-y">
                            <FormInline class="mt-2">
                                <FormLabel  htmlFor="horizontal-form-2" class="sm:w-40" style="text-align: left;"> Type</FormLabel>
                                <FormSelect  v-model="state.data.type" class="w-full" @change="gantiType">
                            ...
                            <FormInline class="mt-2" v-if="pt">
                                <FormLabel  htmlFor="horizontal-form-2" class="sm:w-40" style="text-align: left;"> Duration</FormLabel>
                                <FormSelect  v-model="state.data.duration" class="w-full">
                            ...
                            <FormInline class="mt-2" v-if="pt">
                                <FormLabel  htmlFor="horizontal-form-2" class="sm:w-40" style="text-align: left;"> Jenis</FormLabel>
                                <FormSelect  v-model="state.data.jenis" class="w-full">
                        ...
                        <div class="col-span-12 sm:col-span-6 xl:col-span-6 intro-y">
                            ...
                            <FormInline class="mt-2">
                                <FormLabel  htmlFor="horizontal-form-2" class="sm:w-40" style="text-align: left;"> Sessions</FormLabel>
                                <FormInput type="number" class="col-span-8" v-model="state.data.sessions" placeholder="Insert Sessions"/> 
                            </FormInline>
                        
                            <FormInline class="mt-2">
                                <FormLabel  htmlFor="horizontal-form-2" class="sm:w-40" style="text-align: left;"> Access</FormLabel>
                                <FormSelect  v-model="state.data.accesss" class="w-full">
                            ...
                            <FormInline class="mt-2">
                                <FormLabel  htmlFor="horizontal-form-2" class="sm:w-40" style="text-align: left;"> Validity *Month</FormLabel>
                                <FormInput type="number" class="col-span-8" v-model="state.data.validity" placeholder="Insert Month"/> 
                            </FormInline>

                            <FormInline class="mt-2">
                                <FormLabel  htmlFor="horizontal-form-2" class="sm:w-40" style="text-align: left;"> Status</FormLabel>
                                <FormSelect v-model="state.data.status_packages" class="w-full">
...
<script setup>
    ...
    const gantiType = async () => {
        if(state.data.type=='Personal Training'){
            pt.value = true
        }else{
            pt.value = false
        }
