<script setup>
    ...
    const tampilData = async (page=state.listData.current_page) => {
        ...
        if (user.roles[0].name=='studio') {
            ...
            await Api.get('admin/schedule?page=' + page+ '&q=' + search.value + '&status=' + status.value+  '&studio=' + studio.value+ '&tgl=' + tgl)
            .then(response => {
        ...
            }
            ...
            const tgl = moment().format('YYYY-MM-DD')
            await Api.get('/sales/schedule?page=' + page+ '&q=' + search.value + '&status=' + status.value+  '&studio=' + studio.value+ '&tgl=' + tgl)
            .then(response => {
                state.listData = response.data.data
                loading.value = false
            }).catch(error => {
    ...
    const add = async () =>{
        ...
        Api.defaults.headers.common['Authorization'] = "Bearer " +token
        if (user.roles[0].name=='superAdmin' || user.roles[0].name=='admin') {
            await Api.get('/admin/get_contract', {
                params: {
            ...
            await Api.get('/sales/get_contract', {
                params: {
                    id : state.data.typebooking
                } 
            })
    ...
    const saveBooking = async (id) => {
        ...
        if (user.roles[0].name=='superAdmin' || user.roles[0].name=='admin') {
            await Api.post('/admin/saveBooking', formdata, {
                headers: {
            ...
            await Api.post('/sales/saveBooking', formdata, {
                headers: {
                    'Content-Type': 'multipart/form-data',
                },
            }).then(async (response) => {
    ...
    const searchingMember = useDebounceFn(() => {
        ...
        Api.defaults.headers.common['Authorization'] = "Bearer " +token
        if (user.roles[0].name=='superAdmin' || user.roles[0].name=='admin') {
            Api.get('admin/get_contract?search=' + searchMember.value)
            .then(response => {
                state.listMember = response.data.data
            ...
            Api.get('sales/get_contract?search=' + searchMember.value)
            .then(response => {
                state.listMember = response.data.data
    ...
    const searchingPresent = useDebounceFn(() => {
        ...
        Api.defaults.headers.common['Authorization'] = "Bearer " +token
        if (user.roles[0].name=='superAdmin' || user.roles[0].name=='admin') {
            Api.get('admin/booking?id=' + state.data.id+ '&qpresent=' + searchPresent.value)
            .then(response => {
                state.listBookingPresent = response.data.present
                loadingsycn.value = false
                basicModalPreview.value = false
            ...
            Api.get('sales/booking?id=' + state.data.id+ '&qpresent=' + searchPresent.value)
            .then(response => {
                state.listBookingPresent = response.data.present
                loadingsycn.value = false
                basicModalPreview.value = false
    ...
    const searchingAbsent = useDebounceFn(() => {
        ...
        Api.defaults.headers.common['Authorization'] = "Bearer " +token
        if (user.roles[0].name=='superAdmin' || user.roles[0].name=='admin') {
            Api.get('admin/booking?id=' + state.data.id+ '&qabsent=' + searchAbsent.value)
            .then(response => {
                state.listBookingAbsent = response.data.absent
                loadingsycn.value = false
                basicModalPreview.value = false
            ...
            Api.get('sales/booking?id=' + state.data.id+ '&qabsent=' + searchAbsent.value)
            .then(response => {
                state.listBookingAbsent = response.data.absent
                loadingsycn.value = false
                basicModalPreview.value = false
    ...
    watch(qr, (newQuestion, oldQuestion) => {
        if(user.roles[0].name=='superAdmin' || user.roles[0].name=='admin'){
            const token = localStorage.getItem('token_iss')
            Api.defaults.headers.common['Authorization'] = "Bearer " +token
            Api.get('/admin/my_profile?id=' + qr.value)
            .then(response => {
                state.listProfile = response.data.data
                Api.get('/admin/my_contract?id=' + state.listProfile.idusers)
                .then(responses => {
                    state.listContract = responses.data.data
                    Api.get('/admin/my_booking?id=' + state.listProfile.idusers)
                    .then(responsesss => {
            ...
            const token = localStorage.getItem('token_iss')
            Api.defaults.headers.common['Authorization'] = "Bearer " +token
            Api.get('/sales/my_profile?id=' + qr.value)
            .then(response => {
                state.listProfile = response.data.data
                Api.get('/sales/my_contract?id=' + state.listProfile.idusers)
                .then(responses => {
                    state.listContract = responses.data.data
                    Api.get('/sales/my_booking?id=' + state.listProfile.idusers)
                    .then(responsesss => {
                        state.listBookingClass = responsesss.data.data
                        ...
                        <div class="p-5 box">
                            ...
                            <div class="grid grid-cols-12 gap-6 mt-5">
                                <div class="flex flex-col-reverse col-span-12 lg:col-span-4 2xl:col-span-3 lg:block">
                                    ...
                                    <div class="mt-5 intro-y box lg:mt-0 pt-3"  v-if="state.listProfile===null">
                                    ...
                                    <div class="mt-5 intro-y box lg:mt-0 pt-3" v-else>
                                        <div class="relative flex items-center p-5">
                                            <div class="w-12 h-12 image-fit">
                                                <img
                                                alt="Midone Tailwind HTML Admin Template"
                                                class="rounded-full"
                                                :src="baseUrlFoto + ( state.listProfile.foto || 'user.png')"
                                                />
                                            </div>

                                            <div class="ml-4 mr-auto">
                                                <div class="text-base font-medium">
                                                    {{ state.listProfile.name }}
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="p-5 border-t border-slate-200/60 dark:border-darkmode-400">
                                            <a class="flex items-center mt-5" href="">
                                                <Lucide icon="Mail" class="w-4 h-4 mr-2" />  {{ state.listProfile.email }}
                                            </a>
                                            <a class="flex items-center mt-5" href="">
                                                <Lucide icon="Phone" class="w-4 h-4 mr-2" /> {{ state.listProfile.no_telp.replace(/^(\d{2})\d+(\d{2})$/, '$1***********$2') }}
                                            </a>
                                            <a class="flex items-center mt-5" href="">
                                                <Lucide icon="Calendar" class="w-4 h-4 mr-2" />  {{ moment(state.listProfile.date_birth).format('D MMM, YYYY') }}
                                            </a>
                                            <!-- <a class="flex items-center mt-5" href="">
                                                <Lucide icon="Phone" class="w-4 h-4 mr-2" /> {{ state.listProfile.passport }}
                                            </a> -->
                                            <a class="flex items-center mt-5" href="">
                                                <Lucide icon="Users" class="w-4 h-4 mr-2" /> {{ state.listProfile.gender }}
                                            </a>
                                            <a class="flex items-center mt-5 text-primary" href="">
                                                <Lucide icon="User" class="w-4 h-4 mr-2" /> {{ state.listProfile.namasales }}
                                            </a>
                                            <!-- <a class="flex items-center mt-5" href="">
                                                <Lucide icon="Meh" class="w-4 h-4 mr-2" /> {{ state.listProfile.marital }}
                                            </a> -->
                                        </div>
                                                        ...
                                                        <div class="overflow-x-auto">
                                                            <Table>
                                                                ...
                                                                <Table.Tbody>
                                                                    ...
                                                                    <Table.Tr v-if="Object.keys(state.listContract).length === 0" class="intro-x">
                                                    ...
                                                    <Preview.Panel>
                                                        <div class="overflow-x-auto pt-5">
                                                            <Table>
                                                                ...
                                                                <Table.Tbody>
                                                                    <Table.Tr v-if="state.listBookingClass.length==0" class="intro-x">
                                                                        <Table.Td colspan="10" class="first:rounded-l-md last:rounded-r-md text-center bg-white border-b-0 dark:bg-darkmode-600 shadow-[20px_3px_20px_#0000000b]" >
                                                                            <div class="flex flex-col items-center justify-end col-span-12">
                                                                                <div class="mt-2 text-xs text-center">
                                                                                    ...
                                                                                    <Button variant="primary" href="#" @click="booking(state.listProfile.idusers)">
                                                                    ...
                                                                    <Table.Tr class="intro-x" v-for="(data, index) in state.listBookingClass" :key="data.id" >
                    ...
                    <div class="col-span-12 sm:col-span-12 xl:col-span-12 intro-y">
                        ...
                        <Tab.Group>
                            ...
                            <Tab.Panel class="p-5 leading-relaxed">
                                ...
                                <div class="overflow-x-auto pt-5">
                                <FormInput type="hidden" class="col-span-8" v-model="state.data.id" placeholder="Insert Program"/>
                                    <Table>
                                        <Table.Thead  class="bg-primary text-white">
                                            <Table.Tr class="intro-x">
                                                <Table.Th class="border-b-0 whitespace-nowrap text-center">
