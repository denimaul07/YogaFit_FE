            ...
            >
              ...
              <div class="mt-8 intro-x">
                <FormInput
                  ...
                  placeholder="Email Or Phone Numbers" v-model="user.email"
                />

                <InputGroup class="mt-2">
                    <FormInput placeholder="Password" v-model="user.password"   :type="showPassword ? 'text' : 'password'" />
        ...
        basicModalPreview.value = false
          ...
          if (localStorage.getItem('loginAttempts') > 2) {
            ...
            .then(() => {
              ...
              setWarningModalPreview(true)
              loading.value = false
              if (pesan.value=='Email or Phone Number or Password is incorrect') {
