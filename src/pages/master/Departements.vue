<template>
  <div class="flex flex-col items-center mt-8 intro-y sm:flex-row">
    <h2 class="mr-auto text-lg font-medium">Departements</h2>
        ...
        <Dialog.Panel>
            ...
            <Dialog.Description class="grid grid-cols-12 gap-4 gap-y-3">
                <div class="col-span-12 sm:col-span-6">
                    <FormLabel htmlFor="modal-form-1"> Kode </FormLabel>
                    <FormInput id="modal-form-1" type="hidden" v-model="id" placeholder="Insert Group Name" />
                    <FormInput id="modal-form-1" type="text" v-model="kode" placeholder="Insert Kode" />
                    <FormInput id="modal-form-1" type="hidden" v-model="action" placeholder="Insert Group Name" />
                </div>

                <div class="col-span-12 sm:col-span-6">
                    <FormLabel htmlFor="modal-form-1"> Deptname </FormLabel>
                    <FormInput id="modal-form-1" type="text" v-model="deptname" placeholder="Insert Kode" />
                </div>

                <div class="col-span-12 sm:col-span-6">
                    <FormLabel htmlFor="modal-form-6"> Group Dept </FormLabel>
                    <FormSelect id="modal-form-6" v-model="group_dept">
                ...
                <div class="col-span-12 sm:col-span-6">
                    ...
                    <FormSelect id="modal-form-6" v-model="status">
                        <option value="0">Active</option>
...
<script setup>
  ...
  const saveData = async () => {
    if(action.value=="INSERT"){
      ...
      await Api.put('/admin/department', {
        id : id.value,
        kode : kode.value,
        deptname : deptname.value,
        group_dept : group_dept.value,
          ...
          formatter(cell) {
                ...
                const edit = stringToHTML(`<div class="flex items-center lg:justify-center">
                              ...
                              .then(response => {
                                ...
                                kode.value = datas.value[0].kode
                                deptname.value = datas.value[0].deptname
  ...
  watch(value, async (newQuestion, oldQuestion) => {
    tabulator.value.setFilter("deptname","like",value.value);
  })
