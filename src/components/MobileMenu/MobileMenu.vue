...
import { useSideMenuStore } from "../../stores/side-menu.ts";
import {
  FormattedMenu,
  nestedMenu,
} from "../../layouts/TopMenu/top-menu";
    ...
    >
      ...
      <ul class="py-2">
        ...
        <template v-for="(menu, menuKey) in formattedMenu">
          ...
          <li v-else-if="checkRole(menu.roles)" :key="menuKey">
            ...
            <Transition  v-if="menu.subMenu">
              ...
              >
                <li
                  ...
                  :key="subMenuKey"
                >
                  <Menu v-if="checkRole(subMenu.roles)"
                    :menu="subMenu"
                    :formattedMenuState="[formattedMenu, setFormattedMenu]"
                    level="second"
                    :setActiveMobileMenu="setActiveMobileMenu"
